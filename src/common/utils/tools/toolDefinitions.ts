...
export const TOOL_DEFINITIONS = {
  ...
  session_history: {
    ...
    description:
      ...
      "task_id (a task ID returned by task/task_list) reads the retained history of one of this workspace's own descendant sub-agents instead; unknown or unauthorized IDs return task_not_found, and a descendant whose session files were removed returns session_unavailable. " +
